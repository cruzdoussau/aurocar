  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-ink/86 backdrop-blur-xl">
      <div className="container-x flex h-20 items-center justify-between gap-5">
        ...
        <a href="/agendar#agendar" className="hidden rounded-lg bg-action px-5 py-3 text-sm font-black uppercase text-white shadow-red transition hover:-translate-y-0.5 hover:bg-red-600 md:inline-flex">
          Agendar ahora
        </a>
